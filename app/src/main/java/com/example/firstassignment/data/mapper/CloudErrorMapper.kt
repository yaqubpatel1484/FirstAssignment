package com.example.firstassignment.data.mapper

import android.util.Log
import com.example.firstassignment.data.response.ErrorModel
import com.example.firstassignment.data.response.ErrorStatus
